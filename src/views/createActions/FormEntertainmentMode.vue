<template>
  ...
  import { EntertainmentSubActions, CreateActions } from "../../helper/enums"
  ...
  export default {
    ...
    computed: {
      getSubActionsOption() {
        return [
          EntertainmentSubActions.EVENTS,
          EntertainmentSubActions.SPORTING,
          EntertainmentSubActions.AMUSEMENTRIDES,
          "Others"
        ]
      }
    },
